...
import com.et.et.customcontrolsdemo.ApplicationApp;
...
public class LuoPanFragment extends Fragment {
    ...
    public View onCreateView(LayoutInflater inflater, @Nullable ViewGroup container, @Nullable Bundle savedInstanceState) {
        ...
        // -----------location config ------------
        locationService = ((ApplicationApp) getActivity().getApplication()).locationService;
    ...
    private BDLocationListener mListener = new BDLocationListener() {
        ...
        public void onReceiveLocation(BDLocation location) {
            ...
            if (null != location && location.getLocType() != BDLocation.TypeServerError) {
                ...
                locationInfo.setText(String.format("位置%s, 维度%s 经度%s",
                        location.getCity() + location.getDistrict() + location.getStreet() + location.getAddrStr()+"",
